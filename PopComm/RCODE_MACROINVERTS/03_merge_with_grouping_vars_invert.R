####################################################################
# -- Biodiversity Macroinvert merging -- pop comm group -- Stream Resiliency RCN
...
dat_tax_groups_simple <- dat_tax_groups %>%
  select(taxa_group, SITE_ID, site_COMID, root_COMID, vpu, acceptedtsn, acceptedname, acceptedrank, 
