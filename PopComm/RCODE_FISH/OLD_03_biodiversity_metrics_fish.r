...
read_filename <- paste0('NAQWA_fish_biodata_cleaned_with_spatial_groupings.csv')
...
write_to_google_drive(
  ...
  write_filename = 'NAQWA_fish_derived_biodiversity_metrics_by_continetnal_US.csv',
  my_path_to_googledirve_directory = 'Spatial Dynamics WG/Pop-comm group/NAQWA_Biodata_All_NEW_November2018/FISH')
##########################################################
...
write_to_google_drive(
  ...
  write_filename = 'NAQWA_fish_derived_biodiversity_metrics_by_huc_dir.csv',
  my_path_to_googledirve_directory = 'Spatial Dynamics WG/Pop-comm group/NAQWA_Biodata_All_NEW_November2018/FISH')
##########################################################
...
write_to_google_drive(
  ...
  write_filename = 'NAQWA_fish_derived_biodiversity_metrics_by_root_SITE_ID.csv',
  my_path_to_googledirve_directory = 'Spatial Dynamics WG/Pop-comm group/NAQWA_Biodata_All_NEW_November2018/FISH')
##########################################################
